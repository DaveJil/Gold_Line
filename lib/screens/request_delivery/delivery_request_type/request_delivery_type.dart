  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Select Booking Type", style: TextStyle(color: Colors.black),),
        ...
        child: Padding(
          ...
          child: ListView(
            children:  [
              ...
              SelectTypeCard(
                titleText: "Dispatch Bikes, InterState,\nInternational Delivery",
                subText: "Get Good and Packages from one\nplace to another now ",
              ...
              SelectTypeCard(
                ...
                subText: "Wanna Move from place to place, get\nthis done by using Goldline Ride\n Services ",
                image: "assets/ride.svg",
                onTap: () {
                  CustomDisplayWidget.displayAwesomeNotificationSnackBar(context, "Coming Soon", "Coming soon");
                },
              ),
