...
class AcceptedInterCityRides extends StatefulWidget {
  const AcceptedInterCityRides({Key? key}) : super(key: key);

  @override
  State<AcceptedInterCityRides> createState() => _AcceptedInterCityRidesState();
}

class _AcceptedInterCityRidesState extends State<AcceptedInterCityRides> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      deliveries = deliveryListProvider.checkAcceptedVInterCityRides(context);
    });
    super.initState();
  }
